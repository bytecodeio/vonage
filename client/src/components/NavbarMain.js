  ...
  return (
    <Container fluid className="padding-0">
      ...
      <Navbar collapseOnSelect expand="lg">
        ...
        <svg class="campaign-header__logo-full"  height="50px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 867.2 229">
        ...
        <g>
          ...
          <Navbar.Collapse id="responsive-navbar-nav">
            ...
            <Nav className="align-items-center">
              ...
              <i class="fal fa-user me-1"></i><a href="#login">{message}</a>
              </Navbar.Text>
            </Nav>
          </Navbar.Collapse>
        </Container>
